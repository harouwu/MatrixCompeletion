...
def do_test_imc(k = 20, d1 = 40, d2 = 40, n1 = 200, n2 = 200, sparsity = 0.1, noisy_level = 0.1):
...
def do_test_dirty_imc(k1 = 20, k2 = 20, d1 = 40, d2 = 40, n1 = 200, n2 = 200, sparsity = 0.3, noisy_level = 0.1):
